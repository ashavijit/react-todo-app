...
const App = () => {
  ...
  <>
	...
	<div class="footer">
		<a href='https://github.com/ashavijit' target='_blank' rel="noopener noreferrer"><FaGithub className='github'/></a>

    
    <a href="https:gitlab.com/rdx640" target='_blank' rel="noopener noreferrer"><FaGitlab className='gitlab'/></a>
	</div>
	</>
  );
};
